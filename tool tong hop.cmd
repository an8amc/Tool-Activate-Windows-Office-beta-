...
type blanked.txt
choice /c:123456789A /n /m ">_"
if errorlevel 1 goto actwin
if errorlevel 2 goto upwin
if errorlevel 3 goto remw
if errorlevel 4 goto restbq
if errorlevel 5 goto actoff
if errorlevel 6 goto remo
if errorlevel 7 goto restbq
if errorlevel 8 goto check
if errorlevel 9 goto gopy
